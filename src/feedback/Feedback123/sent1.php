      ...
      <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Sent Appreciation</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <thead class=" text-primary">
                        <th style="font-size:18px; color:#ffffff;">
                         Sno.
                        </th>
                        <th style="font-size:18px; color:#ffffff;">
                         Colleague email
...
Can I share with you a bit of feedback
                      ...
                      <tbody>
                         ...
                         $check = "SELECT * FROM `sent` WHERE `from` LIKE '$from' ORDER BY date DESC LIMIT 10
";
$result = mysqli_query($db, $check);
$num =mysqli_num_rows($result);

while ($row = mysqli_fetch_array($result)) {
 echo "<tr><td>" . $row["sno"]. "</td><td>" . $row["to"] . "</td><td>" . $row["a"] . "</td><td>" . $row["a1"] . "</td><td>"
. $row["date"]. "</td></tr>";
