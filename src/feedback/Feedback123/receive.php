...
//  echo 
//  "<tr><td style=\"$tdStyle\">" . $row["sno"]. "</td>
//  <td style=\"$tdStyle\">" . $row["from"] . "</td>

//  <td style=\"$tdStyle\">" . $row["a"] . "</td>
//  <td style=\"$tdStyle\">" . $row["a1"] . "</td>
 
//  <td style=\"$tdStyle\">". $row["date"]. "</td>
//  <td style=\"$tdStyle\"><a href='$id=$row[sno]'><center>$icon</center></a></td>
...
echo "<tr>" .
            ...
            "<td style='$tdStyle'><input type='hidden' name='a'  value='" . $row["a"] . "'  />".$row["a"]."</td>".
            "<td style='$tdStyle'><input type='hidden' name='a1'  value='" . $row["a1"] . "'  />".$newtext."</td>".
...
//             "<td style=\"$tdStyle\">" . $row["a1"] . "</td>" .
//             "<td style=\"$tdStyle\">" . $row["date"] . "</td>" . 
//             "<td style='$tdStyle'><input type='hidden' name='edit'  id='" . $id . "'  /><center>
//             <button type='button' class='editbtn'>".$icon."</button>
//             </center></td>".
          
//             // "<td style='$tdStyle'><input button class='btn btn-warning edit_data' data-toggle='modal' type='button' data-target='#update_modal'". $row['sno']."><span class='glyphicon glyphicon-edit'></span> Edit</button></td>".
