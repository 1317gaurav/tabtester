...
$toFrom = strstr($toname, '.', true);
$toUserName=ucfirst($toFrom);
...
$read=$_POST['id']; 
$sql = "UPDATE `sent` SET `pread`=1 WHERE sno=$read";
...
<div style="padding:20px; text-align:center; border: 5px solid #003399">
       ...
       <br><br>
       <span style="font-size:25px;color:#003399;"><b><?php echo "$toUserName" ?></b></span><br/><br/>
       <span style="font-size:20px; font-family:Arial, Helvetica, sans-serif;"><i>You have received a shout Out from<b><span style="font-weight:600"> <?php echo "$fname" ?> </span></b>for exhibiting <b><span style="font-weight:600">
           <?php echo "$a" ?></span></b> as a quality.</i></span> <br/><br/>
       <span style="font-size:30px"><img src="assets/img/logo.png"</span> <br/><br/>
       <span style="font-size:20px; font-family:Arial, Helvetica, sans-serif;"><span style="font-weight:600">Comment</span>:&nbsp;<?php echo "$a1" ?></span> <br/><br/>
       <span style="font-size:20px;font-weight:500"><b>Thank you for your dedication and commitment.</b></span> <br/><br/>
       <span style="font-size:18px;color:#003399;font-weight:500">&nbsp;<i><b><?php echo "$date" ?></b></i></span><br>
                ...
                <div class="card-body">
                  ...
                  Read/Unread
                      ...
                      <tbody>
                         ...
                         $check = "SELECT * FROM `sent` WHERE `to` LIKE '$from' ORDER BY date DESC LIMIT 10";
$result = mysqli_query($db, $check);
$num =mysqli_num_rows($result);
...
echo "<tr>" .
            ...
            "<td style='$tdStyle'><input type='hidden' name='from'  value='" . $row["from"] . "'  />".$row["from"]."</td>".
             "<td style='$tdStyle'><input type='hidden' name='dateu'  value='" . $row["dateu"] . "'  />".$row["dateu"]."</td>".
            ...
            "<td style='$tdStyle'><input type='hidden' name='a'  value='" . $row["a"] . "'  /></td>".
            "<td style='$tdStyle'><input type='hidden' name='a1'  value='" . $row["a1"] . "'  /></td>".
            "<td style='$tdStyle'><input type='hidden' name='fname'  value='" . $row["fname"] . "'  /></td>".
            "<td style='$tdStyle'><input type='hidden' name='to'  value='" . $row["to"] . "'  /></td>".
            "</form>".
            "</tr>";
...
?>
              ...
              <a href="receive.php"><i class="fas fa-arrow-alt-circle-left" style="font-size:40px;color:#003399;text-shadow:2px 2px 4px #000000;padding-left:10px;"></i></a>
