          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card" >
                <div class="card-header card-header-primary" >
                  ...
                  <p class="card-category" style="font-size:16px;  "> <b>Suggestion Form</b></p>
                </div><br><br>
                <div class="card-body">
                  <form method="post" action="mail12.php">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="2" name="subject" required></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <br>
                       ...
                       <div class="row">
                        ...
                        <div class="form-group">
                          <!--<label>About Me</label>-->
                          <div class="form-group">
                            <label class="bmd-label-floating">Please take a moment to fill out this suggestion form :</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" style="font-size:12px;">Send Suggestion</button>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  <!--<h6 class="card-category" style="color:#216af3;">Territory Implementation</h6>-->
                  <h4 class="card-title" style="font-size:18px; font-weight:500;color:#00097a;">&nbsp;<?=$_SESSION['user']['name']; ?>&nbsp;</h4>
