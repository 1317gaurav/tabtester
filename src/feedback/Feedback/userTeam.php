            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" style="font-size:16px; "> <b>Team Appreciation </b></p>
                </div><br><br>
                <div class="card-body">
                  <form method="post" action="mailTeam.php">
                       <div class="row">
                       <div class="col-md-12">
...
<fieldset>
  ...
  <select class="form-control dropdown" id="occupation" name="msg">
   ...
   <option value="Be an Expert">Be an Expert</option>
      ...
      <option value="Humbleness">Humbleness</option>
       <option value="Assertiveness">Assertiveness</option>
        <option value="Empowering">Empowering </option>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" style="font-size:12px;">Send Appreciation</button>
